...
from model.smallnet import SCTransNet as SCTransNet
# from loss import *
...
parser.add_argument("--model_names", default=['log_ickd'], type=list,###HERE
                    help="model_name: 'ACM', 'Ours01', 'DNANet', 'ISNet', 'ACMNet', 'Ours01', 'ISTDU-Net', 'U-Net', 'RISTDnet'")
parser.add_argument("--pth_dirs", default=['SCTransNet_335_best.pth.tar', ], type=list)###替换这里'', ''
parser.add_argument("--dataset_dir", default='../Dataset', type=str, help="train_dataset_dir")
parser.add_argument("--dataset_names", default=['IRSTD-1K'], type=list,###替换这里
                    help="dataset_name: 'NUAA-SIRST', 'NUDT-SIRST', 'IRSTD-1K', 'SIRST3', 'NUDT-SIRST-Sea'")
parser.add_argument("--img_norm_cfg", default=None, type=dict,
                    help="specific a img_norm_cfg, default=None (using img_norm_cfg values of each dataset)")
parser.add_argument("--save_img", default=False, type=bool, help="save image of or not")
parser.add_argument("--save_img_dir", type=str, default=r'./save_img/',###替换这里，改俩地方这里
                    help="path of saved image")
parser.add_argument("--save_log", type=str, default=r'./log_cmkd/', help="path of saved .pth")###替换这里
